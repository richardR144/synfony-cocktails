...
class PageController extends AbstractController
{
    ...
    public function displayHome()
    {
        ...
        $lastTwoCocktails = array_slice($cocktails, -2, 2, true);
        // On utilise array_slice pour obtenir les deux derniers cocktails
        
        return $this->render('home.html.twig', ["cocktails" => $lastTwoCocktails]);
    }
}
